...
<html lang="en">
    ...
    <body class="border-t-8 border-orange-400 bg-gray-50 text-gray-800 leading-normal font-sans">
        <div class="flex flex-col justify-between min-h-screen max-w-xl mx-auto px-4">
            ...
            <footer class="text-center text-sm mt-12" role="contentinfo">
                <div>
                    <div class="uppercase mb-4 text-xs text-gray-500 tracking-wider">Hosted by</div>

                    <a href="https://twitter.com/gonedark" class="group inline-block mx-1 sm:mx-2 text-base text-gray-600 hover:text-gray-800">
                    ...
                    <a href="https://twitter.com/jessarchercodes" class="group inline-block mx-1 sm:mx-2 text-base text-gray-600 hover:text-gray-800">
